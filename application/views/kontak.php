                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Kontak Tagihan</h5>
                                            <p class="m-b-0">Daftar Kontak yang terdaftar di wa sender</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                ...
                                                <div class="card-header-right">
                                                    <a href="<?=base_url("Ngadimin/tambahkontak/")?>">
                                                        <button  class="btn btn-primary btn-round waves-effect waves-light">Tambah Kontak</button>
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="card-block table-border-style">
                                                <div class="table-responsive">
                                                    <table id="kontak" class="table table-hover">
                                                        <thead>
                                                            <tr>
                                                                <th>#</th>
                                                                <th>Nama</th>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><a href="<?php echo base_url('/Ngadimin/edit_kontak') ?>/<?php echo $row->nomor ?>"><button class="btn waves-effect waves-light btn-success"><i class="ti-pencil-alt"></i></button></a>   
                                                                <a href="<?php echo base_url('/Ngadimin/fungsiDelete') ?>/<?php echo $row->nomor ?>"><button class="btn waves-effect waves-light btn-danger"><i class="ti-trash"></i></button></a></td>
                                                            </tr>
                                                            <?php } ?>
                                                        </tbody>
                                                    </table>
