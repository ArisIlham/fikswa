                                            ...
                                            <div class="col-md-12">
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <form class="form-material" action="<?php echo base_url(). 'Ngadimin/tambahtagihanaksi'; ?>" method="post">
                                                            ...
                                                            <div class="form-group form-default">
                                                                <input type="text" name="nomor_tagihan" class="form-control" required="">
                                                                <span class="form-bar"></span>
                                                            ...
                                                            <div class="form-group form-default form-static-label">
                                                                <input type="date" name="tgl_reminder" class="form-control" required="">
                                                                <span class="form-bar"></span>
                                                            ...
                                                            <div class="form-group form-default">
                                                                <input type="nomor" name="nominal_tagihan" class="form-control" required="">
                                                                <span class="form-bar"></span>
