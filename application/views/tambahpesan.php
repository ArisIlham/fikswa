                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Tambah Reminder</h5>
                                            <p class="m-b-0">Silahkan Tambah Reminder</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb-title">
                                            ...
                                            <li class="breadcrumb-item"><a href="<?php echo base_url("Ngadimin/tambahpesan")?>">Tambah Reminder</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5>Input Reminder</h5>
                                                    </div>
                                                    <div class="card-block">
                                                        <form class="form-material" action="<?php echo base_url(). 'Ngadimin/tambahpesanaksi'; ?>" method="post" enctype="multipart/form-data">
                                                            <div class="form-group form-default form-static-label">
                                                            <label class="col-sm-0 col-form-label">Select Nama</label>
                                                                    
                                                                <select name="id_kontak" id="" class="form-control">     
                                                                    <?php 
                                                                    foreach ($kontak as $key => $value) {  
                                                                    ?>
                                                                    <option value="<?php echo $value->id_kontak?>"><?php echo $value->nama?></option>
                                                            ...
                                                            <div class="form-group form-default form-static-label">
                                                            <label class="col-sm-0 col-form-label">Select Tagihan</label>
                                                                <select name="id_tagihan" id="" class="form-control">     
                                                                    <?php 
                                                                    foreach ($tagihan as $key => $value) {  
                                                                    ?>
                                                                    <option value="<?php echo $value->id_tagihan?>"><?php echo $value->nama_tagihan?></option>
                                                            ...
                                                            <div class="form-group form-default form-static-label">
                                                                ...
                                                                <label class="float-label">Tanggal Bayar</label>
                                                            </div>
                                                            <div class="form-group form-default">
                                                                <label class="col-sm-0 col-form-label">Upload File</label>
                                                                <div class="col-sm-10">
