                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb-title">
                                            <li class="breadcrumb-item">
                                                <a href="index.html"> <i class="ti-agenda"></i> </a>
                                            </li>
                                            ...
                                            <div class="col-md-12">
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <form class="form-material" action="<?php echo base_url(). 'Ngadimin/edit_aksi'; ?>" method="post">
                                                            <div class="form-group form-default">
                                                                <input type="text" name="nama" class="form-control" value="<?php echo $querydatadetail->nama ?>" required="">
                                                                <span class="form-bar"></span>
                                                                <label class="float-label">Nama</label>
                                                            </div>
                                                            <div class="form-group form-default">
                                                                <input type="text" name="nomor" class="form-control" value="<?php echo $querydatadetail->nomor ?>" required="">
                                                                <span class="form-bar"></span>
                                                                <label class="float-label">Nomor WA</label>
                                                            </div>
