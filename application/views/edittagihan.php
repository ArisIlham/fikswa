...
<head>
    <title>Tambah Kontak Kang Hutang </title>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Tambah Kontak</h5>
                                            <p class="m-b-0">Silahkan Tambah Kontak Baru</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb-title">
                                            ...
                                            <li class="breadcrumb-item"><a href="<?php echo base_url("Ngadimin/kontak")?>">Kontak</a>
                                            </li>
                                            <li class="breadcrumb-item"><a href="<?php echo base_url("Ngadimin/tambahkontak")?>">Tambah Kontak</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <form class="form-material" action="<?php echo base_url(). 'Ngadimin/edittagihan'; ?>" method="post">
                                                            <div class="form-group form-default">
                                                                <input type="text" name="nama_tagihan" class="form-control" value="<?php echo $querydatatagihan->nama_tagihan?>" required="" >
                                                                <span class="form-bar"></span>
                                                                <label class="float-label" >Nama Tagihan</label>
                                                            </div>
                                                            <div class="form-group form-default">
                                                                <input type="text" name="nomor_tagihan" class="form-control" value="<?php echo $querydatatagihan->nomor_tagihan?>" required="">
                                                                <span class="form-bar"></span>
                                                                <label class="float-label">Nomor Tagihan</label>
                                                            </div>
                                                            <div class="form-group form-default">
                                                                <input type="text" name="jenis_tagihan" class="form-control" value="<?php echo $querydatatagihan->jenis_tagihan?>" required="">
                                                                <span class="form-bar"></span>
                                                                <label class="float-label">Jenis Tagihan</label>
                                                            </div>
                                                            <div class="form-group form-default form-static-label">
                                                                <input type="date" name="tgl_reminder" class="form-control" value="<?php echo $querydatatagihan->tgl_reminder?>" required="">
                                                                <span class="form-bar"></span>
                                                                <label class="float-label">Tanggal Reminder</label>
                                                            </div>
                                                            <div class="form-group form-default form-static-label">
                                                                <input type="date" name="tgl_tagihan" class="form-control" value="<?php echo $querydatatagihan->tgl_tagihan?>" required="">
                                                                <span class="form-bar"></span>
                                                                <label class="float-label">Tanggal Tagihan</label>
                                                            </div>
                                                            <div class="form-group form-default">
                                                                <input type="nomor" name="nominal_tagihan" class="form-control" value="<?php echo $querydatatagihan->nominal_tagihan?>" required="">
                                                                <span class="form-bar"></span>
                                                                <label class="float-label">Nominal Tagihan</label>
                                                            </div>
                                                            <button type= 'submit' value='Tambah' class="btn btn-primary btn-round waves-effect waves-light">Simpan</button>
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
